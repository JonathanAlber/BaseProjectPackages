...
namespace Base.SettingsPackage.Components
{
    ...
    public class RebindSetting : StringSettingComponent
    {
        ...
        public InputActionAsset ActionAsset => _resolvedAsset;
...
#region Unity Callbacks
        ...
        public void CaptureOverrides()
        {
            ...
            TypedSetting.Value = HasAnyOverride()
                ? _resolvedAsset.SaveBindingOverridesAsJson()
                : string.Empty;
        }
        ...
        protected override void Apply(string overridesJson)
        {
            ...
            {
                _resolvedAsset.RemoveAllBindingOverrides();
                return;
            }

            _resolvedAsset.LoadBindingOverridesFromJson(overridesJson);
        }

        private bool HasAnyOverride()
        {
            foreach (InputBinding binding in _resolvedAsset.bindings)
            {
