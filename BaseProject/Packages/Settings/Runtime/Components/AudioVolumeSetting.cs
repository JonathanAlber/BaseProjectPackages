...
namespace Base.SettingsPackage.Components
{
    ...
    /// One instance per audio channel, for example music or sfx. The setting key matches the mixer parameter
    ...
    public sealed class AudioVolumeSetting : FloatSettingComponent
    {
        ...
        [SerializeField] [NotNullOrEmpty] [AudioMixerParameter(nameof(audioMixer))]
