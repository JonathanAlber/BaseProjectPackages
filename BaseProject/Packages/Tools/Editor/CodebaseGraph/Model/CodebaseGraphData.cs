...
namespace Base.ToolsPackage.Editor.CodebaseGraph.Model
{
    ...
    internal sealed class CodebaseGraphData
    {
        ...
        /// </summary>
        internal int FieldsCreditedByNestedType { get; set; }
        ...
        /// </summary>
        internal int FieldsCreditedByUnknownScript { get; set; }

        /// <summary>Number of types in the scan.</summary>
        internal int TypeCount => Types.Count;
        ...
        internal TypeNodeInfo FindType(TypeKey key) => Types.GetValueOrDefault(key);
        ...
        internal MemberNodeInfo FindMember(MemberKey key) => Members.GetValueOrDefault(key);
        ...
        internal int CountExcludedTypes()
        {
            int count = 0;
        ...
        internal int CountMemberIssues()
        {
            int count = 0;
