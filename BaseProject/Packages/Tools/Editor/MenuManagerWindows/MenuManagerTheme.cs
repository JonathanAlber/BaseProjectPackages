...
namespace Base.ToolPackage.Editor.MenuManagerWindows
{
    ...
    internal static class MenuManagerTheme
    {
        ...
        public static Color SectionColor() => EditorPalette.Pick(new Color(0.35f, 0.45f, 0.6f, 0.25f),
            new Color(0.35f, 0.45f, 0.6f, 0.18f));

        /// <summary>Tint that marks a row as read only.</summary>
        public static Color LockedColor() => EditorPalette.Tint(0.02f, 0.03f);

        /// <summary>Tint of every second entry row.</summary>
        public static Color RowStripeColor() => EditorPalette.Stripe;

        /// <summary>Line that stands for a separator in the built menu.</summary>
        public static Color SeparatorColor() => EditorPalette.Tint(0.45f);

        /// <summary>Faint line shown while hovering a spot where a separator can be added.</summary>
        public static Color SeparatorHintColor() => EditorPalette.Tint(0.14f);

        /// <summary>Tint of the row that is currently being dragged.</summary>
        public static Color SelectionColor() => EditorPalette.SelectionFill;

        /// <summary>Tint of the entry an overview window linked to.</summary>
        public static Color FocusColor() => Fade(EditorPalette.Focus, 0.22f);

        /// <summary>Color of the line that marks the drop target.</summary>
        public static Color AccentColor() => Fade(EditorPalette.Accent, 0.9f);

        /// <summary>Tint behind a priority that was overridden by hand.</summary>
        public static Color OverrideColor() => Fade(EditorPalette.Focus, 0.18f);

        /// <summary>Color of the vertical lines that mark the nesting depth.</summary>
        public static Color GuideColor() => EditorPalette.Tint(0.1f, 0.12f);
        ...
        public static void DrawGuides(Rect full, int depth) => EditorRows.DrawIndentGuides(full, depth, GuideColor());
        ...
        public static Rect LineAt(float y, Rect row, int depth)
