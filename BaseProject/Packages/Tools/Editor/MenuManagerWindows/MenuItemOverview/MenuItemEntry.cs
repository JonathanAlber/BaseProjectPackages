...
namespace Base.ToolPackage.Editor.MenuManagerWindows.MenuItemOverview
{
    ...
    internal sealed class MenuItemEntry
    {
        ...
        internal string PriorityLabel { get; }
        ...
        internal static MenuItemEntry Attributed(string menuPath, Type declaringType, string methodName, int priority,
        ...
        internal static MenuItemEntry Managed(string entryId, string menuPath, Type declaringType, string methodName,
