...
namespace Base.ToolPackage.Editor.CodebaseGraph
{
    ...
    public sealed class CodebaseGraphLegend : VisualElement
    {
        ...
        private const string ShapeMemberText = "Narrow, one member";
        private const string ShapeNamespaceText = "Widest, rounded, a namespace";
        private const string ShapesTitle = "Shape";
        private const string ShapeTypeText = "Square corners, a type, dashed for an interface";
        private const string StateDismissedText = "Dismissed, silenced everywhere";
        private const string StateFindingText = "Still waiting to be dealt with";
        private const string StateTitle = "Findings";
        ...
        private const string VisibilityTitle = "Stripe and text color";
        ...
        public CodebaseGraphLegend()
        {
            ...
            _header = new Button(Toggle) { text = ExpandedText };
            Add(_header);
