...
{
    /// <summary>
    /// Simple AES-256 encryption. A fresh random IV is created for every save and stored at the front
    /// of the file, so the same data never looks the same twice.
    /// </summary>
    public sealed class AesEncryptor : ISaveEncryptor
    {
        ...
        /// <inheritdoc/>
        /// <exception cref="InvalidDataException">When the data is too short to hold an IV.</exception>
