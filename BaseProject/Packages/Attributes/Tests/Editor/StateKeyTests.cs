...
namespace Base.AttributesPackage.Tests
{
    ...
    public sealed class StateKeyTests
    {
        ...
        /// </summary>
        [Test]
        public void ACategoryKeepsTwoUsesOfOneNameApart()
            => Assert.That(StateKey.For(typeof(StateKeyTests), "titles", Name),
        ...
        /// </summary>
        [Test]
        public void TwoComponentsOfOneFieldDoNotCollide()
            => Assert.That(StateKey.For(Path, Component), Is.Not.EqualTo(StateKey.For(Path, Component + 1)));
        ...
        /// </summary>
        [Test]
        public void ATypeKeyAndAnInstanceKeyAreNotTheSame()
            => Assert.That(StateKey.For(typeof(StateKeyTests), Path), Is.Not.EqualTo(StateKey.For(InstanceId, Path)));
    }
}