...
{
    /// <summary>
    /// Draws a small label after a field, usually a unit.
    /// </summary>
    /// <remarks>
    /// The constants are the point. A unit written as a literal is one typo away from disagreeing with
    /// the identical unit three fields down, and nothing can tell you that "m/s" and "m/s " are the same
    /// thing. Naming them makes the set greppable and the spelling decided once.
    /// <para>
    /// The string constructor stays for the units nobody standardized. It is the exception, not the
    /// default.
    /// </para>
    /// </remarks>
    ...
    public sealed class SuffixAttribute : PropertyAttribute
    {
        ...
        /// <summary>The text shown after the value.</summary>
        public string Text { get; }

        /// <summary>Creates the attribute.</summary>
        /// <param name="text">The text shown after the value, ideally one of the constants here.</param>
