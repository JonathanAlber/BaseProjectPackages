namespace Base.AttributePackage
{
    ...
    public static class ReferenceWindowInfo
    {
        ...
        public static readonly string MenuLocation = MenuPath.Replace(PathSeparator, ReadableSeparator);

        /// <summary>Pointer appended to validation logs, with the location on its own line.</summary>
        public static readonly string LogPointer = "See Required References window\n" + MenuLocation;
    }
}