...
namespace Base.AttributePackage.Editor.Drawers
{
    ...
    /// <see cref="AudioMixerParameterAttribute"/>. While the AudioMixer reference is missing or has no
    ...
    internal sealed class AudioMixerParameterDrawer : WarningFieldDrawer
    {
        private const string ExposedParametersProperty = "m_ExposedParameters";
        private const string ParameterNameProperty = "name";

        protected override string UsageMessage => AttributeNames.Usage<AudioMixerParameterAttribute>("a string");
        ...
        protected override string Evaluate(SerializedProperty property)
            => Evaluate(property, (AudioMixerParameterAttribute)attribute, out _names);
        ...
        private static string Evaluate(SerializedProperty property, AudioMixerParameterAttribute attribute,
            out string[] names)
        {
            names = null;
