...
{
    /// <summary>
    /// Sizes, colors and lazily built styles for the <see cref="ServiceLocatorWindow"/>, so the
    /// window itself stays about layout and interaction rather than appearance.
    /// <para>
    ...
    /// </remarks>
    internal sealed class ServiceLocatorStyles
    {
        ...
        /// <summary>Gap between the state icon and the name next to it.</summary>
        internal const float IconGap = 3f;

        /// <summary>Edge length of the small state icon in front of a problem row.</summary>
        internal const float IconSize = 14f;

        /// <summary>Smallest width the state column takes, so short badges still line up.</summary>
        ...
        /// <summary>Width of the button that selects and pings an instance.</summary>
        ...
        internal static Color AliveBadgeColor => WithAlpha(EditorPalette.Success, BadgeAlpha);
        ...
        internal static Color MismatchBadgeColor => WithAlpha(EditorPalette.Warning, BadgeAlpha);
        ...
        /// <summary>Tint laid over a row that reports a problem.</summary>
        internal static Color ProblemRowColor => WithAlpha(EditorPalette.Danger, ProblemRowAlpha);
        ...
        /// <summary>Fill of the summary pill when at least one entry reports a problem.</summary>
        ...
        /// <summary>The registered type, which is what the eye should land on first.</summary>
